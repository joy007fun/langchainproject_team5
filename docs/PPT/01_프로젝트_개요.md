...
graph LR
    ...
    style System fill:#f3e5f5,stroke:#4a148c,stroke-width:3px,color:#000
    style Output fill:#e8f5e9,stroke:#1b5e20,stroke-width:3px,color:#000

    %% 노드 스타일
    style Q fill:#90caf9,stroke:#1976d2,color:#000
    style A fill:#ba68c8,stroke:#7b1fa2,color:#fff
    style R fill:#ce93d8,stroke:#7b1fa2,color:#000
    style W fill:#ce93d8,stroke:#7b1fa2,color:#000
...
graph TB
    ...
    %% Subgraph 스타일
    style Problems fill:#e1f5ff,stroke:#01579b,stroke-width:3px,color:#000
    style Details fill:#f3e5f5,stroke:#4a148c,stroke-width:3px,color:#000
    style Impact fill:#ffebee,stroke:#c62828,stroke-width:3px,color:#000
    ...
    style D2 fill:#ba68c8,stroke:#7b1fa2,color:#fff
    style D3 fill:#ab47bc,stroke:#4a148c,color:#fff
    style I1 fill:#ef9a9a,stroke:#c62828,color:#000
    style I2 fill:#ef9a9a,stroke:#c62828,color:#000
    style I3 fill:#ef9a9a,stroke:#c62828,color:#000
```
...
graph LR
    ...
    %% Subgraph 스타일
    style Solution fill:#e8f5e9,stroke:#1b5e20,stroke-width:3px,color:#000
    style Features fill:#e1f5ff,stroke:#01579b,stroke-width:3px,color:#000
    style Benefits fill:#f3e5f5,stroke:#4a148c,stroke-width:3px,color:#000

    %% 노드 스타일
    style S1 fill:#a5d6a7,stroke:#388e3c,color:#000
    style S2 fill:#81c784,stroke:#2e7d32,color:#000
    style S3 fill:#66bb6a,stroke:#2e7d32,color:#fff
    style F1 fill:#90caf9,stroke:#1976d2,color:#000
    style F2 fill:#64b5f6,stroke:#1976d2,color:#000
    style F3 fill:#42a5f5,stroke:#1565c0,color:#000
...
graph TB
    ...
    %% Subgraph 스타일
    style Team fill:#e1f5ff,stroke:#01579b,stroke-width:3px,color:#000
    style Roles fill:#e8f5e9,stroke:#1b5e20,stroke-width:3px,color:#000

    %% 노드 스타일
    style TL fill:#90caf9,stroke:#1976d2,color:#000
    style M1 fill:#64b5f6,stroke:#1976d2,color:#000
    style M2 fill:#64b5f6,stroke:#1976d2,color:#000
    style M3 fill:#64b5f6,stroke:#1976d2,color:#000
    style R1 fill:#a5d6a7,stroke:#388e3c,color:#000
    style R2 fill:#81c784,stroke:#2e7d32,color:#000
    style R3 fill:#81c784,stroke:#2e7d32,color:#000
    style R4 fill:#81c784,stroke:#2e7d32,color:#000
```
...
graph LR
    ...
    %% Subgraph 스타일
    style Before fill:#ffebee,stroke:#c62828,stroke-width:3px,color:#000
    style After fill:#e8f5e9,stroke:#1b5e20,stroke-width:3px,color:#000
    style Impact fill:#f3e5f5,stroke:#4a148c,stroke-width:3px,color:#000

    %% 노드 스타일
    style B1 fill:#ef9a9a,stroke:#c62828,color:#000
    style B2 fill:#ef9a9a,stroke:#c62828,color:#000
    style B3 fill:#ef9a9a,stroke:#c62828,color:#000
    style A1 fill:#a5d6a7,stroke:#388e3c,color:#000
    style A2 fill:#81c784,stroke:#2e7d32,color:#000
    style A3 fill:#81c784,stroke:#2e7d32,color:#000
    style I1 fill:#ce93d8,stroke:#7b1fa2,color:#000
    style I2 fill:#ba68c8,stroke:#7b1fa2,color:#fff
    style I3 fill:#ab47bc,stroke:#4a148c,color:#fff
```
